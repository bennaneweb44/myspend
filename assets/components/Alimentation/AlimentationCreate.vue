    ...
    <b-modal ref="modal" id="create-alimentation" v-show="showModal" hide-footer hide-header>      
      <div class="d-block text-center bg-info">
        ...
        <div class="mt-2 mb-2">
          ...
          <textarea class="form-control form-control-sm text-primary mb-1" rows="4" v-model="alimentationNew.commentaires" value="" placeholder="Commentaires (optionnel)"></textarea> 
